...
import { S3RequestOptions, S3UploadOptions, S3GetOptions } from './types';
/**
...
export declare class PicoS3 {
    ...
    getProviderConfig(): import("./types").SERVICE_PROVIDER_CONFIG;
    ...
    getPresignedUrl(options: S3GetOptions): Promise<string>;
}
